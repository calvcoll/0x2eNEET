...
namespace DotNEET.Xml.Migrations
{
    ...
    {
        /// <summary>
        /// Return a non-changing guid based on type classname. SO BE CAREFUL WHEN RENAMING CLASSES !
        /// </summary>
        /// <typeparam name="T">
        /// The migration (used for constraint to avoid code completion pollution)
        /// </typeparam>
