    ...
    public class Executer : IDisposable
    {
        ...
        protected virtual void Dispose(bool dispose)
        {
            if (dispose)
            {
                try
                {
                    ...
                    this.executerTask.GetAwaiter().OnCompleted(() =>
                        {
                            this.executerTask.Dispose();
        ...
        private void ExecutionLoop()
        {
            ...
            try
            {
                ...
                {
                    Task<object> del;
                    if (this.toExecute.TryTake(out del, System.Threading.Timeout.Infinite, this.executerTaskCanceler.Token))
                    {
            ...
            {
                Trace.TraceInformation("Received cancellation : " + ex.ToString());
            }
